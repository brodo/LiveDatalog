...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("LiveDatalog", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "LiveDatalog" is the name you will use in your source code to
                // import this module (e.g. `@import("LiveDatalog")`). The name is
    ...
    b.step("fmt", "Modify source files in place to have conforming formatting")
        .dependOn(&b.addFmt(.{ .paths = fmt_paths }).step);
